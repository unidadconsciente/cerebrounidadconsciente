...
# Mantenemos TU nombre de archivo y TU función
...
with tab_matriz:
    ...
    # TODO este bloque ahora está indentado para que SOLO se vea en la Pestaña 1
...
# PESTAÑA 2: ARQUITECTO DE SESIONES
with tab_ppts:
    # Llamamos a TU función con el nombre que definiste
